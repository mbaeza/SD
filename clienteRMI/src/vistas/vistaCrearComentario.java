...
public class vistaCrearComentario extends javax.swing.JFrame {
    private conexionRMI conexion = new conexionRMI();
    public static String Name;

    public vistaCrearComentario() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Crear comentario"));

        LabelNombre.setText("Seleccione el profesor:");

        LabelPass.setText("Comentario:");

        ButtonIngresar.setText("Publicar");
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "profesor1", "profesor2", "profesor3", "profesor4", "profesor5" }));
    ...
    private void ingresar(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ingresar
     /*   //Recuperamos nombre y pass de la vista
        ...
        vistaCrearComentario.Name = Nombre;
        ...
        try {
            ...
            Logger.getLogger(vistaCrearComentario.class.getName()).log(Level.SEVERE, null, ex);
        }*/
